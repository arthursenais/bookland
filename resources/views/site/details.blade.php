                ...
                <div class="sm:mt-10">
                    ...
                    <div
                        ...
                        <a href="{{ route('createEmprestimo', $livro->slug) }}"
                            class="p-2 text-white transition border-t border-b border-l rounded sm:bg-inherit border-sky-600 hover:bg-sky-600 hover:text-white bg-sky-600 sm:p-0 sm:px-2 sm:text-sky-600 sm:rounded-full">Empréstimo</a>
                        {{-- <button
